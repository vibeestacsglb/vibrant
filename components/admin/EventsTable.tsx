...
import { deleteEvent } from "@/app/(admin)/admin/(protected)/events/actions";
...
export default function EventsTable({ events, category }: Props) {
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium uppercase tracking-wider ${
                        event.category === "tech"
                          ? "bg-shrinik-500/10 text-shrinik-400 border border-shrinik-500/20"
                          : "bg-vibeesta-500/10 text-vibeesta-400 border border-vibeesta-500/20"
                      }`}
                    >
                      {event.category}
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        ...
                        className="inline-flex p-2 text-ink-400 hover:text-vibeesta-400 hover:bg-vibeesta-400/10 rounded-lg transition-colors"
                      >
